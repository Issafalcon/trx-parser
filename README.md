...
## Additional forked functionality
The code has been modified slightly to allow parsing of files generated by [mocha-trx-reporter](https://github.com/Infragistics/mocha-trx-reporter)

This extends the original purpose of the action as a dotnet test result parser, by allowing trx reports from [MochaJs](https://mochajs.org/) based testing frameworks as well
  ...
  Build:
    ...
    steps:
      ...
      - name: Parse Trx files
        uses: Issafalcon/trx-parser@v0.1.1
        id: trx-parser
        with:
